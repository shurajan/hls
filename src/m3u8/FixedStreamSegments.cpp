...
namespace m3u8 {
    ...
    // Конструктор для фиксированного видео
    FixedStreamSegments::FixedStreamSegments(const std::string &masterPlaylistURI, Resolution resolution, network::NetworkClientBase* network_client)
